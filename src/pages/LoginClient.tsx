  ...
  return (
    <div className="min-h-screen bg-white flex">
       ...
       <div className="hidden lg:flex lg:w-1/2 bg-black relative items-center justify-center overflow-hidden">
           {/* Imagem de Fundo Abstrata/Urbana */}
           <div 
       ...
       {/* Lado Direito - Form (Mobile & Desktop) */}
       <div className="w-full lg:w-1/2 flex flex-col relative">
           ...
           <div className="flex-1 flex flex-col justify-center px-8 sm:px-16 max-w-xl mx-auto w-full">
               <div className="mb-10 animate-in slide-in-from-bottom-4 duration-700">
                   ...
                   <p className="text-gray-500 mt-2">
                       {isSignUp ? "Preencha seus dados para criar uma conta gratuita." : "Faça login para solicitar sua próxima corrida."}
                   </p>
               </div>
               ...
               <form onSubmit={handleAuth} className="space-y-5 animate-in slide-in-from-bottom-8 duration-700 delay-150">
                   {isSignUp && (
                       <div className="relative group">
                           ...
                           <Input 
                               ...
                               className="h-14 pl-12 bg-gray-50 border-gray-200 text-base rounded-2xl focus:ring-2 focus:ring-yellow-500/20 focus:border-yellow-500 transition-all"
                   ...
                   <div className="relative group">
                       ...
                       <Input 
                           type="email" placeholder="Endereço de Email" 
                           className="h-14 pl-12 bg-gray-50 border-gray-200 text-base rounded-2xl focus:ring-2 focus:ring-yellow-500/20 focus:border-yellow-500 transition-all"
                   ...
                   {!isSignUp && (
                       <div className="flex justify-end">
                           <span className="text-sm font-semibold text-gray-400 hover:text-yellow-600 cursor-pointer transition-colors">
                               Esqueceu a senha?
                           </span>
                       </div>
                   )}
                   ...
                   <Button 
                       className="w-full h-14 text-lg font-bold rounded-2xl bg-slate-900 hover:bg-black text-white shadow-xl shadow-slate-200 transition-all hover:scale-[1.02] active:scale-[0.98]"
                       disabled={loading}
                   >
               ...
               <div className="mt-10 pt-6 border-t border-gray-100 text-center animate-in fade-in duration-1000 delay-300">
                   <p className="text-gray-500">
                       ...
                       <button onClick={() => setIsSignUp(!isSignUp)} className="ml-2 font-bold text-yellow-600 hover:text-yellow-700 hover:underline">
           ...
           <div className="p-6 text-center lg:hidden">
               <p className="text-xs text-gray-300 font-medium">GoldDrive &copy; 2024</p>
           </div>
       </div>
    </div>
  );
